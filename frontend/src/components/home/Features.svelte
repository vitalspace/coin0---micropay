<section class="relative py-20 px-8 overflow-hidden">
 <!-- Background Effects -->
 <div class="absolute inset-0 bg-gradient-to-br from-slate-900/90 via-slate-800/95 to-slate-900/90"></div>
 <div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(0,191,255,0.1),transparent_60%)]"></div>
 <div class="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(138,43,226,0.1),transparent_60%)]"></div>

 <!-- Floating Particles -->
 <div class="absolute top-20 left-20 w-2 h-2 bg-cyan-400 rounded-full opacity-60 animate-pulse"></div>
 <div class="absolute top-40 right-32 w-1 h-1 bg-purple-400 rounded-full opacity-40 animate-pulse" style="animation-delay: 1s;"></div>
 <div class="absolute bottom-32 left-1/4 w-1.5 h-1.5 bg-cyan-300 rounded-full opacity-50 animate-pulse" style="animation-delay: 2s;"></div>
 <div class="absolute top-60 right-20 w-1 h-1 bg-purple-300 rounded-full opacity-30 animate-pulse" style="animation-delay: 3s;"></div>
 <div class="absolute bottom-20 left-1/2 w-1 h-1 bg-pink-300 rounded-full opacity-35 animate-pulse" style="animation-delay: 1.5s;"></div>

 <div class="relative z-10 max-w-6xl mx-auto">
   <!-- Section Header -->
   <div class="text-center mb-16">
     <div class="relative inline-block group">
       <h2 class="text-5xl md:text-6xl lg:text-7xl font-black relative z-10">
         <span class="bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-lg"
       ...
       <!-- Decorative Elements -->
       <div class="absolute -top-4 -left-4 w-8 h-8 border-t-2 border-l-2 border-cyan-400 opacity-60"></div>
       <div class="absolute -top-4 -right-4 w-8 h-8 border-t-2 border-r-2 border-purple-400 opacity-60"></div>
       <div class="absolute -bottom-4 -left-4 w-8 h-8 border-b-2 border-l-2 border-pink-400 opacity-60"></div>
       <div class="absolute -bottom-4 -right-4 w-8 h-8 border-b-2 border-r-2 border-cyan-400 opacity-60"></div>
     </div>

     <p class="text-xl md:text-2xl text-gray-300 mt-6 max-w-3xl mx-auto leading-relaxed">
       Powerful capabilities that make <span class="text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text font-semibold">micro-transactions</span>
   ...
   <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 place-items-center">
     ...
     <div class="animate-fadeInUp flex flex-col items-center text-center" style="animation-delay: 0.3s">
       ...
       <div class="relative bg-gradient-to-br from-slate-800/70 via-slate-800/50 to-slate-900/70 backdrop-blur-md p-8 border border-cyan-500/20 hover:border-cyan-400/40 hover:shadow-2xl hover:shadow-cyan-400/10 transition-all duration-500 hover:-translate-y-3 w-full max-w-sm overflow-hidden group">
         ...
         <div class="absolute top-3 right-3 w-1 h-1 bg-cyan-400 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300"></div>
         <div class="absolute bottom-3 left-3 w-1 h-1 bg-purple-400 rounded-full opacity-40 group-hover:opacity-80 transition-opacity duration-300"></div>
     ...
     <div class="animate-fadeInUp flex flex-col items-center text-center" style="animation-delay: 0.6s">
       ...
       <div class="relative bg-gradient-to-br from-slate-800/70 via-slate-800/50 to-slate-900/70 backdrop-blur-md p-8 border border-purple-500/20 hover:border-purple-400/40 hover:shadow-2xl hover:shadow-purple-400/10 transition-all duration-500 hover:-translate-y-3 w-full max-w-sm overflow-hidden group">
         ...
         <!-- Top border accent -->
         <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-400 via-pink-500 to-cyan-400"></div>
         <!-- Decorative corner elements -->
         <div class="absolute top-3 right-3 w-1 h-1 bg-purple-400 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300"></div>
         <div class="absolute bottom-3 left-3 w-1 h-1 bg-pink-400 rounded-full opacity-40 group-hover:opacity-80 transition-opacity duration-300"></div>

         <div class="relative z-10">
           <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl mx-auto mb-6 shadow-lg shadow-purple-400/30 group-hover:scale-110 transition-transform duration-300">
             <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     <div class="animate-fadeInUp flex flex-col items-center text-center md:col-span-2 lg:col-span-1 md:col-start-1 lg:col-start-auto md:justify-self-center lg:justify-self-auto"
       ...
       <div class="relative bg-gradient-to-br from-slate-800/70 via-slate-800/50 to-slate-900/70 backdrop-blur-md p-8 border border-emerald-500/20 hover:border-emerald-400/40 hover:shadow-2xl hover:shadow-emerald-400/10 transition-all duration-500 hover:-translate-y-3 w-full max-w-sm overflow-hidden group">
         ...
         <!-- Top border accent -->
         <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-400 via-green-500 to-teal-400"></div>
         <!-- Decorative corner elements -->
         <div class="absolute top-3 right-3 w-1 h-1 bg-emerald-400 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300"></div>
         <div class="absolute bottom-3 left-3 w-1 h-1 bg-teal-400 rounded-full opacity-40 group-hover:opacity-80 transition-opacity duration-300"></div>

         <div class="relative z-10">
           <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-400 to-green-500 rounded-2xl mx-auto mb-6 shadow-lg shadow-emerald-400/30 group-hover:scale-110 transition-transform duration-300">
             <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
