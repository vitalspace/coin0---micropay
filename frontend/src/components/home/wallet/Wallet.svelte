      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                class="text-xl font-bold white mb-1 font-mono drop-shadow-lg text-white"
              >
                $12.47
              </div>
            </div>
        ...
        <div class="floating-notification-tailwind">
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs font-semibold text-white animate-pulse"
              >Payment Instant</span
            >
            <span
              class="text-sm font-bold text-yellow-400 drop-shadow-lg animate-pulse"
              >+ $0.05</span
            >
          </div>
        </div>
